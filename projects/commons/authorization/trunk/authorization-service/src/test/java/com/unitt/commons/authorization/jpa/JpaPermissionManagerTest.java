...
import com.unitt.commons.authorization.Authorization;
import com.unitt.commons.authorization.AuthorizationImpl;
...
public class JpaPermissionManagerTest implements ReservedPermission
{
    ...
    protected Authorization           manager;
    ...
    public void setUp() throws Exception
    {
        ...
        // load data set
        dbHelper.onSetup();
        manager = (Authorization) applicationContext.getBean( "Authorization" );
        Assert.assertNotNull( "Missing authorization manager.", manager );
        ( (AuthorizationImpl) manager ).initialize();
