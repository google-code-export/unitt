...
public class WebSocketConnectConfig {
    ...
    private boolean activeExtensionModifiesReservedBits;
    ...
    public boolean getActiveExtensionModifiesReservedBits() {
        return activeExtensionModifiesReservedBits;
    }

    public void setActiveExtensionModifiesReservedBits(boolean aActiveExtensionModifiesReservedBits) {
        activeExtensionModifiesReservedBits = aActiveExtensionModifiesReservedBits;
    }
